...
#include <catch.hpp>
#include <sstream>
#include "../ObjectAdapter/App/Adapter/ModernToOldLibAdapter.h"
#include "../ObjectAdapter/lib/modern_graphics_lib/CModernGraphicsRenderer.h"
...
TEST_CASE("ModernToOldLibAdapter correctly initializes and finalizes drawing")
{
    ...
    {
        CModernGraphicsRenderer renderer(out);
